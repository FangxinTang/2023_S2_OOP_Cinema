    ...
    def get_remaining_available_seats(self):
        ...
        for seat in self.seats:
            if seat.is_available:
                remaining_available_seats.append(seat)
        return remaining_available_seats
    
    def get_num_of_seats_available(self):
        num_of_seats_available = len(self.get_remaining_available_seats())
        return num_of_seats_available
...
class Movie:
    ...
    def __init__(self, title:str, description:str, duration_mins:int, language:str, country:str, genre:str, release_date:str):
...
class Booking:
    ...
    def __init__(self, user_id, screening_id, num_seats, booking_datetime, payment_id=None, booked_seats=None):
        ...
        self.booked_seats if booked_seats is not None else []
...
class Notification:
    ...
    next_id = 1
    def __init__(self, send_datetime:datetime, content:str, payment_id:int):
